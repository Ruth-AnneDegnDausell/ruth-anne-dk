  ...
  await client.transaction()
    .createOrReplace({
      ...
      sections: [
        ...
        section('da-1', 'Vil du vide mere?', 'Jeg fortæller gerne mere om, hvordan det fungerer i praksis - både det praktiske og det formelle omkring ordning, tilskud og aftale. Tag endelig fat i mig.'),
      ],
      links: [
      ...
      sectionsEn: [
        ...
        section('en-1', 'Want to know more?', 'I am happy to explain how it works in practice - both the practical side and the formal questions about the scheme, the supplement, and the agreement. Feel free to reach out to me.'),
      ],
      linksEn: [
