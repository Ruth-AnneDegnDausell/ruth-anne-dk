...
const ASPECT_OPTIONS = [
  { title: 'Horisontalt · 4:3 (standard)', value: 'aspect-[4/3]' },
  { title: 'Horisontalt · 3:2', value: 'aspect-[3/2]' },
  { title: 'Horisontalt · 16:9 (bredt)', value: 'aspect-[16/9]' },
  { title: 'Kvadratisk · 1:1', value: 'aspect-square' },
  { title: 'Vertikalt · 2:3', value: 'aspect-[2/3]' },
...
export const fotografierGallerySchema = defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'array',
      of: [{ type: 'reference', to: [{ type: 'fotoKategori' }] }],
    }),
    defineField({
      name: 'items',
