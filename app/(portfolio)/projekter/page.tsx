...
const CATEGORIES = {
  da: ['Alle', 'Branding', 'Illustration', 'UX · UI'],
  en: ['All', 'Branding', 'Illustration', 'UX · UI'],
}
...
export default function Projekter() {
  ...
  const filtered =
    active === allLabel
      ? PROJECTS
      : PROJECTS.filter((p) => {
          if (active === 'Branding') return p.category === 'branding'
          if (active === 'Illustration') return p.category === 'illustration'
          if (active === 'UX · UI') return p.category === 'ux-ui'
          return true
        })
