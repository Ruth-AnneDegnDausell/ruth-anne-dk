...
const DEFAULT_DA = {
  ...
  awards: [{ title: 'Legatmodtager', desc: "HK/Privats Ophavsretsfond for afgangsprojekt", year: '2023', testimonialHref: '/cv/udtalelser?i=6' }],
  expLabel: 'Arbejdserfaring', eduLabel: 'Uddannelse', volLabel: 'Frivilligt arbejde', skillsLabel: 'Færdigheder', awardsLabel: 'Udmærkelser',
...
const DEFAULT_EN = {
  ...
  awards: [{ title: 'Grant recipient', desc: "HK/Privats Ophavsretsfond, graduation project", year: '2023', testimonialHref: '/cv/udtalelser?i=6' }],
  expLabel: 'Work experience', eduLabel: 'Education', volLabel: 'Voluntary work', skillsLabel: 'Skills', awardsLabel: 'Awards',
